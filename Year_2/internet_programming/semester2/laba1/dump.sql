...
--
-- Name: news_column_6_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.news_column_6_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.news_column_6_seq OWNER TO postgres;

--
-- Name: news_column_6_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.news_column_6_seq OWNED BY public.news.img;
...
--
-- Name: news img; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.news ALTER COLUMN img SET DEFAULT nextval('public.news_column_6_seq'::regclass);
...
--
-- Name: news_id_uindex; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX news_id_uindex ON public.news USING btree (id);
