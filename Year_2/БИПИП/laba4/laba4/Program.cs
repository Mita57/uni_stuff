...
namespace laba4
{
    class Program
    {
        ...
        public static Semaphore
            Sem1 = new Semaphore(99999, 99999); //В задании про очередь ничего  не былр, так что пусть 99999

        public static Semaphore
            Sem2 = new Semaphore(0, 99999); //Контроль доступа обслуживающих потоков при нуле заявок в очереди - не извлекаем
